		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					...
					<br>
					<p>
						저희 쇼핑몰은 "좋은 상품은 누구에게나 언제든지, 자연스럽고 편안하게<br> 다가갈 수 있어야 한다" 라는
						단순하지만 명확한 신념으로 만듭니다.<br> <br>The wayShop은 합리적인 가격과 믿을 수
						있는 상품으로 온라인 쇼핑몰 업계의 대표주자로 자리매김 하였으며,<br>
						<br> 고객님들의 니즈에 부응하는 퀄리티 높은 자체제작 상품으로 '좋은 상품'의 신념을 지켜나가겠습니다. <br>
						<br> 또한, The wayShop는 기업의 최대가치를 사회적 책임과 사회환원으로 보고 지속적인 가치창출에
						모든 임직원이 하나가 되어 노력하고 있습니다."
					</p>
						...
						<div class="hover-team">
							<div class="our-team">
								...
								<div class="team-content">
									...
									<span class="post">Kakaotalk ID: kfcson<br> E-mail:
