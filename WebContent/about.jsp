   ...
   <div id="container">
      <div class="location_area customer">
         <div class="box_inner">
            ...
            <p class="location">
              상품<span class="path">/</span> 업로드 테스트
            </p>
            <ul class="page_menu clear">
               <li><a href="#" class="on">상품</a></li>
               <li><a href="#">업로드 테스트</a></li>
            </ul>
         </div>
      </div>
            ...
            <tbody>
               ...
               <c:forEach var="v" items="${datas}">
                  <tr>
                     ...
                     <td>${v.price}</td>
                     <td>${v.stock}</td>
                     <td><c:forTokens var = "fileName" items="${v.files }" delims="," varStatus = "st">
                     <c:set var="style" value="" />
                     
                     <a  href="./upload/${fileName}" style="${style}" >${fileName}</a>
                     <c:if test="${!st.last }">
                     /
                     </c:if>
                     </c:forTokens>
