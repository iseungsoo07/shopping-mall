	...
	<div id="container">
		...
		<div class="bodytext_area box_inner">
			<ul class="bbsview_list">
				...
				<li class="bbs_content">
					<div class="editor_content">
						안녕하세요. 믿을 수 있는 여행정보, 투어리스트인투어 입니다.<br /> 안녕하세요. 믿을 수 있는 여행정보, 투어리스트인투어 입니다.<br /> 안녕하세요. 믿을 수 있는 여행정보, 투어리스트인투어
						입니다.<br /> 안녕하세요. 믿을 수 있는 여행정보, 투어리스트인투어 입니다.<br /> 안녕하세요. 믿을 수 있는 여행정보, 투어리스트인투어 입니다.<br /> 안녕하세요. 믿을 수 있는
						여행정보, 투어리스트인투어 입니다.<br /> 안녕하세요. 믿을 수 있는 여행정보, 투어리스트인투어 입니다.<br /> 안녕하세요. 믿을 수 있는 여행정보, 투어리스트인투어 입니다.<br />
						안녕하세요. 믿을 수 있는 여행정보, 투어리스트인투어 입니다.<br /> 안녕하세요. 믿을 수 있는 여행정보, 투어리스트인투어 입니다.<br /> 안녕하세요. 믿을 수 있는 여행정보, 투어리스트인투어
						입니다.<br /> 안녕하세요. 믿을 수 있는 여행정보, 투어리스트인투어 입니다.<br /> 안녕하세요. 믿을 수 있는 여행정보, 투어리스트인투어 입니다.<br /> 안녕하세요. 믿을 수 있는
						여행정보, 투어리스트인투어 입니다.<br /> 안녕하세요. 믿을 수 있는 여행정보, 투어리스트인투어 입니다.<br />
					</div>
				</li>
			</ul>
			...
			<ul class="near_list mt20">
				<li>
					<h4 class="prev">이전글</h4>
					<a href="#">추석 연휴 티켓/투어 배송 및 직접 수령 안내</a>
				</li>
				<li>
					<h4 class="next">다음글</h4>
					<a href="#"> 이번 여름 휴가 제주 갈까? 미션 투어 (여행 경비 50만원 지원) </a>
				</li>
			</ul>
		</div>
		<!-- 본문 끝 -->
