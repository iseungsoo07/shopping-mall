...
<body>
	...
	<div id="container">
		...
		<form method="post" action="./newPro.do" enctype="multipart/form-data">
			<div class="box_inner">
				...
				<center>
								...
								<form id="contactForm">
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<input type="text" class="form-control"
													value="${datas.name}" id="name" name="name"
										...
										<div class="col-md-12">
											<div class="form-group">
												<textarea class="form-control" id="message" name="price"
													value="${datas.price}" placeholder="가격을 작성해주세요." rows="4"
													data-error="Write your message" required></textarea>
												<div class="help-block with-errors"></div>
											</div>
											<input type="text" class="form-control"
													value="${datas.stock}" id="name" name="stock"
													placeholder="재고를 입력해주세요." required
													data-error="Please enter your name">
											<div class="submit-button text-center">
											
												<button class="btn hvr-hover" id="submit" type="submit">공지사항
													작성</button>
