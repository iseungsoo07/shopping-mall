...
public class AddProductAction implements Action {
	...
	public ActionForward execute(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		for (Part p : parts) {
			...
			// int b = fis.read(); // read媛� 1諛붿씠�듃�떒�쐞濡� �씫�뼱�샂 諛섑솚�� int �삎(�떎 �씫�뿀�떎怨�
			// �몴�쁽�븯湲곗쐞�빐 �젙�닔�삎) �떎�씫�뿀�쑝硫� -1�쓣 諛섑솚
			byte[] buf = new byte[1024]; // 諛붿씠�듃�떒�쐞濡� �씫�뼱�삤湲� �쐞�븳 �꽑�뼵
			int size = 0;
			while ((size = fis.read(buf)) != -1) { // 諛붿씠�듃 �떒�쐞濡� �씫�뼱�샂
				fos.write(buf, 0, size); // 諛붿씠�듃�떒�쐞留� �씫�쓣�닔�엳怨� 留덉�留됱뿉 諛붿씠�듃媛� �븞�릺�뒗 �떒�쐞硫� 紐살씫湲곗뿉 0遺��꽣 size
											// 媛��닔源뚯�
